    ...
    where R: gfx::Resources, C: gfx::CommandBuffer<R> 
{
    ...
    for i in 0..sphere_count {  
        ...
        encoder.update_texture::<gfx::format::R8_G8_B8_A8, [u8; 4]>(texture, None, info, &texels[..])
            .unwrap();
    }
}
...
fn main() {
    ...
    let texture_view = factory
        .view_texture_as_shader_resource::<gfx::format::Rgba8>(&texture, (0, 1), gfx::format::Swizzle::new())
